 ...
 *
 * Built on 2026-07-05 at 21:05 UTC
 */
...
class _StringsEn {
	...
	// Translations
	String get appname => 'MFM Triumphant Church';
	...
	List<String> get onboardingpagetitles => [
		'Welcome to MFM Triumphant Church',
	...
	List<String> get onboardingpagehints => [
		...
		'We have brought together the tools you need for church life, Goshen Retreat registration, events, devotionals, notifications, notes, and multi-version Bible.',
	...
	String get logoutfromapphint => 'You can still browse public content, but prayer requests, testimonies, bookings, giving history, and personal notifications need a signed-in account.';
...
class _StringsEs implements _StringsEn {
	...
	// Translations
	@override String get appname => 'MFM Triumphant Church';
	...
	@override List<String> get onboardingpagetitles => [
		'Bienvenido a MFM Triumphant Church',
	...
	@override List<String> get onboardingpagehints => [
		...
		'Hemos reunido las herramientas para la vida de la iglesia, el registro de Goshen Retreat, eventos, devocionales, notificaciones, notas y Biblia de múltiples versiones.',
...
class _StringsFr implements _StringsEn {
	...
	@override List<String> get onboardingpagetitles => [
		'Bienvenue à MFM Triumphant Church',
	...
	@override List<String> get onboardingpagehints => [
		...
		'Nous avons rassemblé les outils pour la vie de l\'église, l\'inscription au Goshen Retreat, les événements, les dévotions, les notifications, les notes et la Bible multi-version.',
...
class _StringsPt implements _StringsEn {
	...
	@override List<String> get onboardingpagetitles => [
		'Bem-vindo ao MFM Triumphant Church',
		'Repleto de recursos',
	...
	@override List<String> get onboardingpagehints => [
		...
		'Reunimos as ferramentas para a vida da igreja, inscrição no Goshen Retreat, eventos, devocionais, notificações, notas e Bíblia em várias versões.',
...
extension on _StringsEn {
	Map<String, dynamic> _buildFlatMap() {
		return <String, dynamic>{
			...
			'onboardingpagetitles.0': 'Welcome to MFM Triumphant Church',
			...
			'onboardingpagehints.1': 'We have brought together the tools you need for church life, Goshen Retreat registration, events, devotionals, notifications, notes, and multi-version Bible.',
			...
			'logoutfromapphint': 'You can still browse public content, but prayer requests, testimonies, bookings, giving history, and personal notifications need a signed-in account.',
...
extension on _StringsEs {
	Map<String, dynamic> _buildFlatMap() {
		return <String, dynamic>{
			...
			'onboardingpagetitles.0': 'Bienvenido a MFM Triumphant Church',
			...
			'onboardingpagehints.1': 'Hemos reunido las herramientas para la vida de la iglesia, el registro de Goshen Retreat, eventos, devocionales, notificaciones, notas y Biblia de múltiples versiones.',
...
extension on _StringsFr {
	Map<String, dynamic> _buildFlatMap() {
		return <String, dynamic>{
			...
			'onboardingpagetitles.0': 'Bienvenue à MFM Triumphant Church',
			...
			'onboardingpagehints.1': 'Nous avons rassemblé les outils pour la vie de l\'église, l\'inscription au Goshen Retreat, les événements, les dévotions, les notifications, les notes et la Bible multi-version.',
...
extension on _StringsPt {
	Map<String, dynamic> _buildFlatMap() {
		return <String, dynamic>{
			...
			'onboardingpagetitles.0': 'Bem-vindo ao MFM Triumphant Church',
			...
			'onboardingpagehints.1': 'Reunimos as ferramentas para a vida da igreja, inscrição no Goshen Retreat, eventos, devocionais, notificações, notas e Bíblia em várias versões.',
